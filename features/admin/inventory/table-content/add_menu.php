...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSQL = "INSERT INTO menu_item (name_item, category_item, price, stock) 
                  VALUES ('$name', '$category', '$price', '$stock')";
    
    $hasilInsertQuery = mysqli_query($connection, $insertSQL);

    if ($hasilInsertQuery) {
        $_SESSION['session_barang'] = "Menu item <b>$name</b> successfully added!";
        $_SESSION['session_type'] = "success";
        header("Location: ../index.php");
        exit();
    } else {
        $_SESSION['session_barang'] = "ERROR: Failed to save data! " . mysqli_error($connection);
        ...
        <div class="card">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="name_item" name="name_item" required placeholder="Enter item name">
                </div>
