...
// Get selected floor (default: 1) - PERSISTENT dengan session
if (isset($_GET['floor'])) {
...
$hours = range(10, 22);
// ==========================================
// HANDLE AJAX REQUESTS - FIXED PENDING RESULT SETS
// ==========================================
...
<body>
    ...
    <script>
        ...
        function updateTableInfo() {
            ...
            if (guests > seats) {
                alert(`This table only has ${seats} seats! Please reduce guests or choose a larger table.`);
        ...
        async function openDetailModal(id) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    const statusClass = 'st-' + data.status;
